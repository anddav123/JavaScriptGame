export const creatureTemplates = {
  Cubling: {
    ...
    nickname: "Cubling",
    color: "#4d9a63",
    spritePath: "assets/creatures/cubling-sprite.svg",
    fallbackSpritePath: "assets/creatures/cubling-sprite.png",
    role: "Starter",
    maxHp: 42,
  ...
  Dandelio: {
    ...
    nickname: "Dandelio",
    color: "#4d9a63",
    spritePath: "assets/creatures/dandelio-sprite.svg",
    fallbackSpritePath: "assets/creatures/dandelio-sprite.png",
    role: "Wildling",
    maxHp: 64,
    moves: ["vineSnap", "focus"],
    description: "A shy meadow creature that hides in moss and strikes with vines."
  ...
  Scorcha: {
    ...
    nickname: "Scorcha",
    color: "#d15b38",
    spritePath: "assets/creatures/scorcha-sprite.svg",
    fallbackSpritePath: "assets/creatures/scorcha-sprite.png",
    role: "Wildling",
    maxHp: 40,
    moves: ["ember", "focus"],
  ...
  Sproutrunk: {
    ...
    nickname: "Sproutrunk",
    color: "#4d9a63",
    spritePath: "assets/creatures/sproutrunk-sprite.svg",
  ...
  Roselle: {
    ...
    nickname: "Roselle",
    color: "#fc8ccd",
    spritePath: "assets/creatures/roselle-sprite.svg",
  ...
  Lilphant: {
    ...
    nickname: "Lilphant",
    color: "#4d77b4",
    spritePath: "assets/creatures/lilphant-sprite.svg",
